...
# Handle an incoming connection that has been accepted by the user
...
def handle_connection(conn, addr):
    with conn:
        ...
        # Return the response from www.google.com back to the client
...
def start_server():
    ...
    with socket.socket(socket.AF_INET, socket.SOCK_STREAM) as server_socket:
        ...
        create new socket called 'conn' to interact with it
        '''
